    ...
    <div className="flex h-screen -mt-10 -mb-20">
      <div className="w-2/12 text-white bg-blue-900 pl-6 pt-6">
        <div className="flex mb-3">
          ...
          <h1 className="ml-2 xl:text-xl lg:text-xl md:text-lg sm:text-sm">Admin</h1>
        </div>
        <div className="flex mb-3">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <p className="ml-2 xl:text-xl lg:text-xl md:text-lg sm:text-sm">Đoan Van Huy</p>
        </div>
        <div className="flex mb-3">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <h1 className="ml-2 xl:text-xl lg:text-xl md:text-lg sm:text-sm">Home Page</h1>
        </div>
        <div className="flex mb-3">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <p className="ml-2 xl:text-xl lg:text-xl md:text-lg sm:text-sm">Category</p>
        </div>
        <div className="flex mb-3">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <p className="ml-2 xl:text-xl lg:text-xl md:text-lg sm:text-sm">List Film</p>
        </div>
        <div className="flex mb-3">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <p className="ml-2 xl:text-xl lg:text-xl md:text-lg sm:text-sm">User</p>
        </div>
      </div>
